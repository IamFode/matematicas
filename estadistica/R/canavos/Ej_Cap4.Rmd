...
## 4.32
Un contador recientemiente graduado pretende realizar el examen CPA. Si el número de veces que se hace el examen constituye un conjunto de eventos independientes con una probabilidad de aprobar a 0.6, ¿cuál es la probabilidad de que no se necesiten más de cuatro intentos para aprobar el examen? ¿Son válidas las suposiciones de independencia y probabilidad constante?
...
## 4.33
De las distribuciones binomial, Poisson, hipergeometrica y binomial negativa, ¿cuáles no consideraria si alguien le dijera, de una distribución en particular que:
