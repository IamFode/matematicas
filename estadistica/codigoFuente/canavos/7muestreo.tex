...
\begin{teo}
    ...
    Como resultado se tiene que la función generadora de momentos de $Y$ es igual a la función generadora de moemtos de $(1/\sqrt{n})\sum_{i=1}^n Z_i$. Del teorema 7.1,
