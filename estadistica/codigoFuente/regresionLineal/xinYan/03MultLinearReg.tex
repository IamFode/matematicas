...
La forma cuadrática con matrices idempotentes se usa ampliamente en el análisis de regresión lineal. Ahora discutimos las propiedades de la matriz idempotente.
