...
\newtheorem{def.}{\large \textbf{Definición}}[chapter]%entorno para definiciones
\newtheorem{post}{\large\textbf{Postulado}}[chapter]%entorno de postulados
\newtheorem{cor}{\textbf{Corolario}}[chapter]
...
\newtheorem{proposicion}{\small \textbf{Proposición}}[chapter]
