...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[(a)]
		...
		forma una base de $U$. Si $q(x)=a+bx+c^2+dx^3\in \mathcal{P}_4(\textbf{F})$ para $a,b,c,d\in \textbf{F}$. Entonces,
		$$
		\begin{array}{rcl}
	...
	\begin{enumerate}[(a)]
		...
		$$\left\{p(x)\in \mathcal{P}_4(\textbf{F})\,|\, p''(6)=0\right\}=\left\{s_1(x-6)^4+s_2(x-6)^3+s_3(x-6)+s_4\,|\, s_1,s_2,s_3,s_4\in \textbf{F}\right\}.$$
		Observe que este conjunto es un espacio vectorial generado por $\left\{1,(x-6),(x-6)^3,(x-6)^4\right\}$, el cual genera $\mathcal{P}_4(\textbf{F})$. Luego, sea
