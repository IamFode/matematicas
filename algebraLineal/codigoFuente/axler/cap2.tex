...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[\bfseries (a)]
		...
		\end{array}
		$$
		Lo que nos muestra que $(x-2)(x-5),(x-2)(x-5),(x-2)(x-5)x^2$ genera $V$. Ahora, demostremos que $(x-2)(x-5),(x-2)(x-5),(x-2)(x-5)x^2$ es linealmente independiente. Con las condiciones dadas anteriormente, tenemos que verificar:
		$$a(x-2)(x-5)+b(x-2)(x-5)x+c(x-2)(x-5)x^2=(x-2)(x-5)\left(a+bx+cx^2\right)=0.$$
		Centremonos en $(a+bx+cx^2)=0$. Ya que, $1,x,x^2$ es linealmente independiente. Entonces, los escalres $a,b,c$ son ceros. Por lo tanto, la lista es linealmente independiente, (ya que $(x-2)(x-5)\left(0+0\cdot x+0\cdot x^2\right)=0$). Así,
	    ...
	    %---------- (b)
	    \item Extienda la base en (a) a una base de $\mathcal{P}_4(\textbf{F})$.\\\\
		Respuesta.-\; Queremos extender la base $\left\{1,(x-2)(x-5),(x-2)(x-5)x,(x-2)(x-5)x^2\right\}$ a una base de $\mathcal{P}_4(\textbf{F})$ de dimensión cinco. 
