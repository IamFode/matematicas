...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[a).]
		...
		$$v_5=(0,0,0,1,0).$$
		Por último, demostremos que estos vectores son base de $\textbf{F}^5$. Por el teorema 2.23 sabemos que, si $m$ vectores generan un espacio vectorial, entonces cualquier lista linealmente independiente en $V$ no puede tener más de $m$ vectores. Así, queda demostrada la independencia lineal de $v_1,v_2,v_3,v_4,v_5$. Por otro lado, notemos que $v_3$
