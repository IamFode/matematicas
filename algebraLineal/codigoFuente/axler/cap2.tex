...
\begin{enumerate}[\bfseries 1.]
    ...
    %------------------- 10.
    \item Suponga $v_1,\ldots,v_m$ es linealmente independiente en $V$ y $W\in V$. Demostrar que si $v_1+w,\ldots,v_m+w$ es linealmente independiente, entonces $w\in \span(v_1,\ldots,v_m)$.\\\\
	Demostración.-\;
