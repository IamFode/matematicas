...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Definción de espacio vectorial %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}[\bfseries 1.]
    ...
    %-------------------- 5.
    \item Demuestre que en la definición de un espacio vectorial (1.19), la condición inversa aditiva se puede reemplazar con la condición de que
    $$0v=0\mbox{ para todo } v\in V.$$
    Aquí, el $0$ en el lado izquierdo es el número $0$, y el $0$ en el lado derecho es la identidad aditiva de $V$. (La frase una condición puede ser reemplazada en una definición significa que la colección de objetos que satisfacen la definición no cambia si la condición original se reemplaza con la nueva condición).\\\\
	Demostración.-\;
