...
\textbf{Demostración de la identidad.-}\; Sean $\lambda=(a+bi)$ y $0=(0+0i)$, para $a,b\in \bf{R}$. Entonces,
$$\begin{array}{rcl}
    \lambda +0 & = & (a+bi) + (0+0i)\\
	       & = & (a+0) + (b+0)i\\
	       & = & a + bi\\
...
\textbf{Demostración de Inverso aditivo.-}\; Sean $\alpha=(a+bi)$ y $\beta=(c+di)$ para $a,b,c,d\in \bf{R}$. Por las propiedades de números reales, $a$ y $b$ tienen inversa, las llamaremos $c$ y $d$ respectivamente tales que $a+c=0$ y $b+d=0$. Por lo tanto,
$$\begin{array}{rcl}
...
\textbf{Demostración de Inverso multiplicativo.-}\;  Sean $\alpha=a+bi$ y $\beta=c+di$ con $a,b,c,d\in \bf{R}$. Entonces,
...
\textbf{Demostración de la distributividad.-}\; Sean $\alpha=a+bi$, $\beta=c+di$ y $\gamma=e+fi$ con $a,b,c,d,e,f\in \bf{R}$. Entonces,
$$\begin{array}{rcl}
...
%------------------- Definición 1.12 -------------------
\begin{tcolorbox}
    \begin{def.}[\boldmath Adición en $\bf{F}^n$]
...
%-------------------- Teorema 1.1 ---------------------
%-------------------- Teorema 1.13 ---------------------
\begin{teo}[Conmutatividad para la adición en $\bf{F}^n$]
	...
	x+y&=&(x_1,\ldots,x_n)+(y_1,\ldots,y_n)\\
	   ...
	   &=&y+x\\
    \end{array}$$
    donde la segunda y cuarta igualdades anteriores se cumplen debido a la definición de suma en $\bf{F}^n$ y la tercera igualdad se cumple debido a la conmutatividad habitual de la suma en $\bf{F}$. \blacksquare\\
\end{teo}
...
\begin{tcolorbox}[colback=white]
    \begin{def.}[\boldmath Inverso aditivo en $\bf{F}^n$]
