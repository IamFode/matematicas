...
\begin{enumerate}[\bfseries 1.]
    ...
    %-------------------- 4. --------------------
    \item Demuestre que $\alpha+\beta=\beta+\alpha$ para todo $\alpha,\beta\in \bf{C}$.\\\\
    ...
    %-------------------- 7. --------------------
    \item Demuestre que para cada $\alpha \in \bf{C}$, existe un único $\beta\in \bf{C}$ tal que $\alpha+\beta=0$.\\\\
    ...
    %-------------------- 8. --------------------
    \item Demuestre que para cada $\alpha \in \bf{C}$ con $\alpha\neq 0$, existe un único $\beta\in \bf{C}$ tal que $\alpha\beta=1$.\\\\
    ...
    %-------------------- 9. --------------------
    \item Demuestre que $\alpha(\beta+\gamma)=\alpha\beta+\alpha\gamma$ para todo $\alpha,\beta,\gamma\in \bf{C}$.\\\\
