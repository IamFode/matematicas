...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[(a)]
		...
		Respuesta.-\; Sean, $A_1$ y $A_2$ dos matrices en $V$ tal que $A_1B=BA_2$ y $A_2B=BA_2$. Entonces, por el definición de subespacio y el teorema 1, para algún $c\in F$:
		$$
		\begin{array}{rcl}
		    cA_1B+BA_2&=&cBA_1+BA_2\\\\
		\end{array}
		$$
