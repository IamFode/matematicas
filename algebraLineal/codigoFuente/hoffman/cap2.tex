...
%-------------------- definición 1.7.
\begin{def.}
    Sea $V$ un espacio vectorial. Una \textbf{base} de $V$ es un conjunto linealmente independiente de vectores de $V$ que genera el espacio $V$. El espacio $V$ es de \textbf{dimensión finita} si tiene una base finita.
\end{def.}
