...
\begin{teo}
	...
	$$\alpha=x_1\alpha_1+x_2\alpha_2+\ldots+x_,\alpha_m$$
	de vectores $\alpha_1,\alpha_2,\ldots,\alpha_m$ de $S$ pertenecen evidentemente a $W$ 
\end{teo}
