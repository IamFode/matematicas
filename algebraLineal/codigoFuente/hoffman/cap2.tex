...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[\bfseries (a)]
		...
		Respuesta.-\; Sea $A=\left\{\alpha = (a_1,a_2,\ldots,a_n)\in \mathbb{R}^n | a_1\geq 0\right\}$. Luego, tomemos un vector $\alpha'=(1,0,\ldots,0)\in A$ tal que $a_1\geq 0$. Ahora notemos que
		$$(-1)\alpha'=(-1)(1,0,\ldots,0)=(-1,0,\ldots,0)\notin A.$$
		lo que contradice el la condición $a_1\heq 0$. Por lo tanto, $A$ no es cerrado con respecto a la multiplicación escalar, por lo que no es un subespacio.\\\\
