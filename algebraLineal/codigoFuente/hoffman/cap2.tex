...
\begin{enumerate}[\bfseries 1.]
    ...
    %-------------------- 8.
    \item Sea $V$ el espacio vectorial de todas las funciones de $R$ en $R$; sea $V_p$ el subconjunto de las funcones pares, $f(-x)=f(x)$; sea $V_i$ el subconjunto de las funciones impares $f(-x)=-f(x)$.\\
	\begin{enumerate}[(a)]
