...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[(1)]
		...
		\begin{enumerate}[(a)]
			...
			\end{array}
			$$
		    \item Asoaciatividad para la multiplicación escalar.\\
			$$
			\begin{array}{rcl}
		    ...
		    \item Distributividad de la multiplicación escalar sobre la adición.
			$$
			\begin{array}{rcl}
		    ...
		    \item Distributividad de la multiplicación sobre la adición de escalares
			$$
			\begin{array}{rcl}
