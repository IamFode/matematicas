...
\declaretheorem[style=mydef, sibling=mydef,title=Notación]{mynotacion}
...
\declaretheorem[style=myteo, sibling=mydef,title=Corolario]{mycor}
\declaretheorem[style=myteo, sibling=mydef,title=Ejemplo]{myejem}
\declaretheorem[style=myteo, sibling=mydef,title=Lema]{mylema}

\newcounter{mysection}[chapter]
\titleclass{\mysection}{straight}[\chapter]
\titleformat{\mysection}[hang]
  {\normalfont\bfseries}{\themysection}{.5em}{}
\titlespacing*{\mysection}{0pt}{17ex plus 1ex minus .2ex}{2.3 ex plus .2ex}
\renewcommand{\themysection}{\large\arabic{chapter}.\Alph{mysection}}
