...
\setcounter{myejem}{37}
%-------------------- Ejemplo 1.38
\begin{myejem}
    Suponga que $U=\left\{(x,x,y,y)\in \textbf{F}^4:x,y\in \textbf{F}\right\}$ y $W=\left\{(x,x,x,y)\in \textbf{F}^4:x,y \in \textbf{F}\right\}$.Entonces,
    $$U+W=\left\{(x,x,y,z)\in \textbf{F}^4:x,y,z\in \textbf{F}\right\}.$$\\
