\begin{enumerate}[\bfseries \mbox{Problema} 1.]
	...
	de la siguiente manera. Sea $x\times x = 0$ entonces,
	\begin{itemize}
	...
	Demostración.-}\; Sea $a,b,c,d,e,f\in \mathbb{R}^n.$, se tiene:
	\begin{center}
	    ...
	    \end{tikzpicture}
	\end{center}
	De donde,  $$\cos (\theta) = \dfrac{\langle e,f\rangle}{\|e\|\|f\|} \quad \Rightarrow \quad \theta = \cos^{-1}\left(\dfrac{\langle a+b, d+a\rangle}{\|e\|\|f\|}\right).$$
