...
\usepackage[text=17cm,left=1.5cm,right=1.5cm, headsep=20pt, top=2.5cm, bottom = 2cm,letterpaper,showframe = false]{geometry} %configuración página
...
\newtheorem{teo}{\textbf{Teorema}}[part]%entorno para teoremas
\newtheorem{ejem}{{\textbf{EJEMPLO}}}[chapter]%entorno para ejemplos
\newtheorem{def.}{\textbf{Definición}}[part]%entorno para definiciones
