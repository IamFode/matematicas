...
\begin{teo} Si $0<a\leq \frac{1}{2}\pi,$ y $n\geq 1,$ tenemos $$\dfrac{a}{n}\sum_{k=1}^n \cos \dfrac{ka}{n}<\sen a < \dfrac{a}{n}\sum_{k=0}^{n-1} \cos \dfrac{ka}{n} \qquad \mbox{(2.6)}.$$
    ...
    en donde otra vez hemos utilizado la desigualdad fundamental $\cos \theta < \theta/sen \theta.$ esta último relación implica (2.12), con lo que se completa la demostración del teorema 2.4.\\\\
