...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[\bfseries (a)]
	    ...
	    %---------- (b)
	    \item Halle una función $f$ que sea continua y acotada en $(0,1]$, pero no uniforme continua en $(0,1]$.\\\\
		Respuesta.-\; Sea $f(x)=\sen(1/x)$. Entonces $f$ es continua y está acotada en $(0,1]$. Luego supongamos que $x=\dfrac{1}{2n\pi+\frac{\pi}{2}} = \dfrac{2}{(4n+1)\pi}$ e $y=\dfrac{1}{(2n+1)+\frac{\pi}{2}}=\dfrac{2}{(4n+3)\pi}$ y $\epsilon =1$, por lo que 
		$$f(x)-f(y)=\sen\left(2n\pi +\dfrac{\pi}{2}\right)-\sen \left[(2n+1)\pi+\dfrac{\pi}{2}\right]=1-(-1)=2>\epsilon.$$
		$$|x-y|=\bigg|\dfrac{2}{(4n+1)\pi}-\dfrac{2}{(4n+3)\pi}\bigg|=\dfrac{4}{(4n+1)(4n+3)\pi}<\delta$$
		Dado cualquier $\delta>0,$ podemos escoger $n$ tal que $|x-y|=\dfrac{4}{(4n+1)(4n+3)\pi}<\delta$. Esto significa que existe $\epsilon>0$ tal que dado cualquier $\delta>0$ existe un par $x,y$ con $|x-y|<\delta$ pero $|f(x)-f(y)|>\epsilon.$\\\\

	    %---------- (c)
	    \item Halle una función $f$ que sea continua y acotada en $[0,\infty)$, pero no uniforme continua en $[0,\infty)$.\\\\
		Respuesta.-\; Sea $f(x)=\sen(x^2)$. Entonces es continua y acotada en $[0,\infty)$. Luego sean $\epsilon=1$ y $x=\sqrt{\dfrac{(4n+1)\pi}{2}}$  e $y=\sqrt{\dfrac{(4n+3)\pi}{2}}$ entonces,
		$$f(x)-f(y)=\sen \left(\dfrac{(4n+1)\pi}{2}\right)-\sen \left(\dfrac{(4n+3)\pi}{2}\right)=1-(-1)=2>\epsilon$$
		$$|x-y|=\bigg|\sqrt{\dfrac{(4n+1)\pi}{2}}-\sqrt{\dfrac{(4n+3)\pi}{2}}\bigg| = \dfrac{\bigg|\dfrac{(4n+1)\pi}{2}-\dfrac{(4n+3)\pi}{2}\bigg|}{\bigg|\sqrt{\dfrac{(4n+1)\pi}{2}}+\sqrt{\dfrac{(4n+3)\pi}{2}}\bigg|}=\dfrac{\sqrt{2\pi}}{\sqrt{4n+1}+\sqrt{4n+3}}$$
		Dado cualquier $\delta>0$, podemos escoger $n$ tal que $|x-y|=\dfrac{\sqrt{2\pi}}{\sqrt{4n+1}+\sqrt{4n+3}}<\delta.$ Esto significa que existe $\epsilon>0$ tal que dado cualquier $\delta>0$ existe un par $x,y$ con $|x-y|<\delta$ pero $|f(x)-f(y)|>\epsilon.$\\\\ 
