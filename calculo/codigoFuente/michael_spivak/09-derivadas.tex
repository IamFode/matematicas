...
\begin{enumerate}[\bfseries 1]
   ...
   \begin{enumerate}[(a)]
    ...
    %-------------------- 23
    \item Demuestre que si $f$ es par, entonces $f'(x)=-f'(-x)$. (Para evitar al máximo la confusión, sea $g(x)=f(-x)$; hállese $g'(x)$ y luego recuerde que otra cosa es $g.$)\\\\
	Demostración.-\; Sea $g(x)=f(-x)$. Por el hecho de que $g(x)=f(cx)\; \Rightarrow \; g'(x)=cf'(cx)$, se sigue $$g(x)=f(-x)\;\Rightarrow \; g'(x)=-f'(-x)$$ 
