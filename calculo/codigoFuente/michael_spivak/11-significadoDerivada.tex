...
\begin{enumerate}[\bfseries 1.]
	...
	\begin{enumerate}[(a)]
	    ...
	    %---------- (a)
	    \item Sea $(x_0,y_0)$ un punto del plano, y sea $L$ la gráfica de la función $f(x)=mx+b.$ Halle el punto $\overline{x}$ tal que la distancia de $(x_0,y_0)$ a $(\overline{x},f(\overlone{x}))$ sea mínima. [Observe que minimizar esta distancia equivale a minimizar su cuadrado. Esto puede simplificar, en cierta medida, los cálculos.]
		Respuesta.-\;
