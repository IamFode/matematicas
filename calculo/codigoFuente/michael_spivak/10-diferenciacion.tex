...
\begin{enumerate}[\bfseries 1.]
    ...
    %-------------------- 21.
	 ...
	 $$c\cdot \left[\right]^{m_1}\cdots \left[\right]^{m_n}\cdot f^{(k)}\left[g(a)\right],$$
	 ...
	 $$cm_\alpha \left[g'(x)\right]^{m_1}\cdots \left[g^{(n)}(x)\right]^{m_\alpha - 1} \cdots \left[g^{(n)}(a)\right]^{m_n}\cdot f^{(k)}\left[g(a)\right]\qquad m_\alpha>0$$
	 o de la forma
	 $$c\left[g'(x)\right]^{m_1+1} \cdots \left[g^{(n)}(x)\right]^{m_n}\cdot f^{(k+1)}\left[g(a)\right].$$\\
