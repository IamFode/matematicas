...
\begin{enumerate}[\bfseries 1.]
    ...
    %-------------------- 14.
	 ...
	 $$\dfrac{x^2}{a^2}+\dfrac{y^2}{b^2}=1 \quad \Rightarrow \quad y=\pm b \sqrt{1-\dfrac{x^2}{a^2}} \quad \Rightarrow \quad y= b \sqrt{1-\dfrac{x^2}{a^2}}.$$
	 Tomando la derivada de la elipse se tiene,
	 $$y'=\dfrac{-\dfrac{b2x}{a^2}}{2\sqrt{1-\dfrac{x^2}{a^2}}}=\dfrac{-bx}{a^2\sqrt{1-\dfrac{x^2}{a^2}}}$$
	 por lo que la pendiente de la tangente será con respecto de $k$ será,
	 $$\dfrac{-bk}{a^2\sqrt{1-\dfrac{k^2}{a^2}}}$$
	 Por otro lado la tangente estará dada por,
	 $$y=\dfrac{-bk}{a^2\sqrt{1-\dfrac{k^2}{a^2}}}x+c$$
	 Reemplazando $x$ por $k$ e $y$ con $b\sqrt{1-\dfrac{k^2}{a^2}}$,
	 $$b\sqrt{1-\dfrac{k^2}{a^2}}=\dfrac{-bk}{a^2\sqrt{1-\dfrac{k^2}{a^2}}}k+c\quad \Rightarrow \quad $$
