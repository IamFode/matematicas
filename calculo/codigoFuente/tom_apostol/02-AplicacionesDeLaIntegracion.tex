...
\begin{teo}
    ...
    Demostración.-\; Supongamos que $f$ es creciente en $[a,b]$, elijamos $x<y$,  y sea $z=\alpha y + (1-\alpha)x.$ Tenemos que demostrar que $A(z)\leq \alpha A(y)+(1-\alpha)A(x)$.  Puesto que $A(z)=\alpha(z)+(1-\alpha)A(z),$ es lo mismo que demostrar que $\alpha A(z)+(1-\alpha)A(z)\leq \alpha A(y)+(1-\alpha)A(x),$ o que
