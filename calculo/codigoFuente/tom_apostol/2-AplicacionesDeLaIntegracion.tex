...
%--------------------32.
\item A partir de la identidad $$2\sen \dfrac{x}{2} \cos kx = \sen(2k+1)\dfrac{x}{2} - \sen(2k-1)\dfrac{x}{2}$$
    ...
    Demostración.-\; Sea $$2\sen \dfrac{x}{2} \cos kx = \sen(2k+1)\dfrac{x}{2} - \sen(2k-1)\dfrac{x}{2}\; \Longrightarrow \;2\sen\dfrac{\pi}{2}\sum\limits_{k=1}^n \cos kx = \sum\limits_{k=1}^n \left[\sen\left(2k+1\right)\dfrac{x}{2}\right]$$ Luego por la propiedad telescópica tenemos
    $$2\sen\dfrac{\pi}{2}\sum\limits_{k=1}^n \cos kx = \sen \left[\right]-\sen\dfrac{x}{2}$$
