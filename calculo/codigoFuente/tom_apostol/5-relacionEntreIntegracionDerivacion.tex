...
\begin{enumerate}[\bfseries 1.]
	...
	\item Nos pide que encontremos $f(t)-f(1)$ cuando $t>1$. Notemos que,
	    $$f(t)-f(1)=v(1)(t-1)+\dfrac{1}{2}a(t)(t-1)^2,\qquad t>1.$$
	    Dado que $v(1)=\dfrac{1+\sen(2\pi)}{1+1}=\dfrac{1}{2}$, tenemos
	    $$f(t)-f(1)=v(1)(t-1)+\dfrac{1}{2}a(t)(t-1)^2,\quad t>1.$$
	    Entonces, 
	    $$f(t)-f(1)=\dfrac{1}{2}(t-1)+\dfrac{1}{2}\left(\pi-\dfrac{1}{2}\right)(t-1)^2,\quad t>1.$$\\
