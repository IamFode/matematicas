...
\begin{teo}[Teorema de Rolle]
    Sea $f$a una función continua en todos los puntos de un intervalo cerrado $[a,b]$ y derivable en cada punto del intervalo abierto $(a,b)$. Supongamos también que 
    $$f(a)=f(b)$$
