...
\begin{enumerate}[\bfseries 1.]
	...
	Respuesta.-\; 
	\begin{enumerate}
	    \item Derivando $f(x)$, tenemos $f'(x)=2x-3$. Luego igualando a $0$ se tiene,
	    ...
	    \item Sea $f''(x)=2$. Ya que $2>0$, entonces por el teorema 4.9 (tom Apostol, capítulo 4) $f'$ es creciente para todo $x$. 
	    \item \;
	    \begin{center}
		\begin{tikzpicture}
