...
En los siguientes Ejercicios, a) hallar todos los puntos x tales que $f'(x) = O$; b) examinar el signo de $f'$ determinar aquellos intervalos en los que $f$ es monótona; c) examinar el signo de $f''$ y determinar aquellos intervalos en los que $f'$ es monótona; d) construir un boceto de la gráfica de $f$. En cada caso, la función está definida para todos los $x$ para los cuales tiene sentido $f(x)$.\\
