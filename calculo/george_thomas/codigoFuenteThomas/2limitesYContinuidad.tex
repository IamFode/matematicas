...
\begin{enumerate}[\bfseries 1.]
    ...
    %----------4.
    \item Regla Regla del producto: $\displaystyle\lim_{x\to c} \left[f(x)\cdot g(x)\right] = L\cdot M$\\\\

    %----------5.
    \item Regla del cociente: $\displaystyle\lim_{x\to c} = \dfrac{L}{M}, \; M\neq 0$\\\\

    %----------6.
    \item Regla Regla de la potencia: $\displaystyle\lim_{x\to c} \left[f(x)\right]^n = L^n, \;n$ es un entero positivo\\\\
