...
\usepackage[text=17cm,left=2.1cm,right=1.9cm, headsep=20pt, top=2.5cm, bottom = 2cm,letterpaper,showframe = false]{geometry} %configuración página
...
\usepackage{mathrsfs}
\usepackage{arydshln} % lineas punteadas
